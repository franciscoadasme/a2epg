...
//	}
	...
	float deviationOfDistanceBetweenTopPeaks = deviationOfDistanceBetweenPeaks(peaksInsideWindow(Up, false));
	float deviationOfDistanceBetweenBottomPeaks = deviationOfDistanceBetweenPeaks(peaksInsideWindow(Down, false));
