...
private:
	...
	void paintSegmentsOfType(QPainter *painter, int type, uint verticalOffset);
	void paintSegment(QPainter *painter, EPSegment *segment, uint verticalOffset);
	void paintHorizontalGrid(QPainter *painter);
	void paintDescriptionForSegment(QPainter *painter, EPSegment *segment, QRectF rect);
	void setPaintAttributesForSegment(QPainter *painter, EPSegment *segment, QRectF rect);
