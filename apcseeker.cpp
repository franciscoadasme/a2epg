...
bool APCSeeker::isAllowedPoint()
{
	...
	float topDeviation = APUtils::getDeviation(topPeakValues, APUtils::getAverage(topPeakValues)) / amplitude;
	float bottomDeviation = APUtils::getDeviation(bottomPeakValues, APUtils::getAverage(bottomPeakValues)) / amplitude;
