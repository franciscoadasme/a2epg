...
void APViewportHandler::goTo(uint position,
                             ...
                             QWidget *target)
{
    ...
    if (aligment == Qt::AlignCenter) {
        // position should at center
        left = position - numberOfPointsThatCanBeDrawn / 2;
    } else {
...
{
    float multiplier = orientation == Qt::Horizontal
