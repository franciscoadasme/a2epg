...
protected:
    ...
    bool satisfyStrongVariantRestrictions(Slope start,
                                          Slope end,
                                          QList<float> topPeaks,
                                          QList<float> bottomPeaks);
    bool satisfyWeakVariantRestrictions(Slope start,
                                        Slope end,
                                        QList<float> topPeaks,
                                        QList<float> bottomPeaks);

    bool areMostInnerPeaksBeneathRoof(Slope start, Slope end,
                                      QList<float> peaks,
